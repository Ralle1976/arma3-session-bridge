...
- **Server**: IONOS VPS (AlmaLinux 9.7, public IP `212.227.54.229`)
...
Windows Player B ─── WireGuard ──┼── IONOS Server (212.227.54.229)
...
1. Download the latest release: **[arma3-session-bridge-setup.exe](https://github.com/Ralle1976/arma3-session-bridge/releases/latest)**
...
| `WG_SERVER_IP` | Public IP of your IONOS server | `212.227.54.229` |
...
Access at `http://212.227.54.229:8090`
...
*Documentation: [Wiki](https://github.com/Ralle1976/arma3-session-bridge/wiki) | [User Manual DE](docs/user-manual-de.md) | [User Manual EN](docs/user-manual-en.md)*
