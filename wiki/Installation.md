...
Download and run the latest installer from [Releases](https://github.com/YourGitHubUser/arma3-session-bridge/releases/latest). The installer handles updates automatically.
