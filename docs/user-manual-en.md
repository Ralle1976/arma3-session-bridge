...
1. Go to: `https://github.com/YourGitHubUser/arma3-session-bridge/releases/latest`
...
*More help available at the [GitHub Wiki](https://github.com/YourGitHubUser/arma3-session-bridge/wiki) or create a [GitHub Issue](https://github.com/YourGitHubUser/arma3-session-bridge/issues).*
