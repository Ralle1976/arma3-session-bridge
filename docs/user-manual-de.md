...
```
Spieler A ──WireGuard──┐
Spieler B ──WireGuard──┼── VPS (öffentliche IP: 212.227.54.229)
...
1. Öffne: `https://github.com/Ralle1976/arma3-session-bridge/releases/latest`
...
- Standard: `http://212.227.54.229:8001`
...
1. Prüfe ob der Server erreichbar ist: `ping 212.227.54.229`
...
3. Server nicht erreichbar
   → ping 212.227.54.229 im Command Prompt
...
3. API-Verbindung testen: Browser → `http://212.227.54.229:8001/health`
...
*Weitere Hilfe findest du im [GitHub Wiki](https://github.com/Ralle1976/arma3-session-bridge/wiki) oder erstelle ein [GitHub Issue](https://github.com/Ralle1976/arma3-session-bridge/issues).*
